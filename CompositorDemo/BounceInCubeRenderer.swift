...
@MainActor
class BounceInCubeRenderer: CustomRenderer {
  ...
  init(layerRenderer: LayerRenderer) throws {
    ...
    let attractorUpdateBase = library.makeFunction(name: "bounceInCubeComputeShader")!
  ...
  -> MTLRenderPipelineState
  {
    ...
    let vertexFunction = library.makeFunction(name: "bounceInCubeVertexShader")
    let fragmentFunction = library.makeFunction(name: "bounceInCubeFragmentShader")
