...
@MainActor
class BounceAroundBallRenderer: CustomRenderer {
  ...
  init(layerRenderer: LayerRenderer) throws {
    ...
    let attractorUpdateBase = library.makeFunction(name: "bounceAroundBallComputeShader")!
    ...
    -> MTLRenderPipelineState
  {
    ...
    let vertexFunction = library.makeFunction(name: "bounceAroundBallVertexShader")
    let fragmentFunction = library.makeFunction(name: "bounceAroundBallFragmentShader")
