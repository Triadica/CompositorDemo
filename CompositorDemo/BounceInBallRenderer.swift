...
@MainActor
class BounceInBallRenderer: CustomRenderer {
  ...
  init(layerRenderer: LayerRenderer) throws {
    ...
    let attractorUpdateBase = library.makeFunction(name: "bounceInBallComputeShader")!
  ...
  -> MTLRenderPipelineState
  {
    ...
    let vertexFunction = library.makeFunction(name: "bounceInBallVertexShader")
    let fragmentFunction = library.makeFunction(name: "bounceInBallFragmentShader")
